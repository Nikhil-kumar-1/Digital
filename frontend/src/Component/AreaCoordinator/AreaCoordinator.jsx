...
export default function AreaCoordinator() {
  ...
  const subjects = [
    ...
    //   desc: "Budgeting, Resource Management, Planning", 
    //   link: "/area-coordinator/resources", 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl mt-10 md:text-5xl font-bold text-center mb-8 pt-10 text-orange-500 animate-pulse">
          Area <span className="text-white">Coordinator</span> Syllabus
        </h1>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-16">
          {subjects.map((s, idx) => (
            ...
            >
              <div className={`p-2 rounded-xl shadow-lg cursor-pointer transition-all duration-300 ${s.color} h-50 flex flex-col justify-center items-center text-center border-2 border-orange-400 hover:border-orange-300 hover:scale-105 hover:shadow-2xl`}>
